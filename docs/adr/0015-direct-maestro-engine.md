...
2.5.1 output; it is not a CI gate and does not prove runtime parity. The accepted follow-up is a
three-layer oracle: parser normalization generated from the pinned upstream corpus, semantic vectors
generated by a JVM harness that calls upstream geometry/default/retry/timing code, and a small set of
app-observable differential scenarios. Deterministic generated layers will run in CI without requiring
Java during normal checks.
